...
const Projectitem = ({...props}: IProjects) => {
  ...
  if (props.id % 2 == 0) {
    return (
      <div className="flex flex-row max-w-[100%] mb-12 sm:flex flex-col max-w-[100%] mb-12 sm:mb-[10px]">
        <img className="max-h-[250px]" src={"src/assets/" + props.img} alt={props.imgAlt}></img>
        <div className="flex flex-col self-end max-w-[64%] ml-[4%] sm:flex flex-col self-center max-w-[90%] mx-[5%]">
          ...
          <div className="flex flex-row  mt-2 sm:max-w-[90%] mx-[5%] justify-center">
